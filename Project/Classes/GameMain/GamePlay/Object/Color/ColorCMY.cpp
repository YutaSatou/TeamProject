...
// コンストラクタ
ColorCMY::ColorCMY( std::uint8_t _c, std::uint8_t _m, std::uint8_t _y )
	: c( _c )
	, m( _m )
	, y( _y )
{
...
// RGB⇔CMYの相互変換
ColorCMY::ColorTuple ColorCMY::convertColor( std::uint8_t element1, std::uint8_t element2, std::uint8_t element3 )
{
